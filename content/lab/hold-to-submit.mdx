...
Moving onto this experiment, one of my favourite parts of this experiment was animating the stars. A simple yet elegant feedback to the user, notifying that the action has been completed. I used the star SVG from <Link href="https://heroicons.com/" target="_blank">heroicons</Link>, a project by the makers of Tailwind CSS.
...
Another intricate detail that makes gives the effect that finishing touch is the letters animating in to change the text from "Submit" to "Submitted". The subtle spring animation makes the effect a lot more appealing.
