...
And then finally applying the radial gradient as a `fill` to our main `<rect />`, and using the mask we created earlier, to achieve the final effect.
