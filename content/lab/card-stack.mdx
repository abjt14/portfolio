...
A huge shoutout goes to <Link href="https://x.com/RoberaGeleta" target="_blank">Robera Geleta</Link> and <Link href="https://x.com/nasm423" target="_blank">Nate Smith</Link> whose work inspired this experiment. The beautiful images used in the demo are by <Link href="https://unsplash.com/@codioful" target="_blank">Codioful</Link>, <Link href="https://unsplash.com/@mymind" target="_blank">mymind</Link>, and <Link href="https://unsplash.com/@seanwsinclair" target="_blank">Sean Sinclair</Link> on Unsplash.
