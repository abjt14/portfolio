...
import { data, type Star as StarData } from "./data";

function StarryBackground({ starCount = 100 }: { starCount?: number }) {
  const count = starCount <= 1024 ? starCount : 1024;
